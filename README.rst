...
dmenu-run.sh
    ``dmenu`` configuration
liftoff/splashdown
    configure (Linux) Chromebook when it leaves and returns home (more: `"Chromebook liftoff and splashdown" <http://www.circuidipity.com/chromebook-liftoff-splashdown.html>`_)
myRsync
